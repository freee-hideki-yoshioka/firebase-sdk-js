...
class FreeeCryptor {
    ...
    async decrypt(token) {
        ...
        return Object.assign(Object.assign({}, token), { accessToken: this.crypt("aaarer", this.decipher(algorithm, key, iv), OUT, IN), refreshToken: this.crypt(refreshToken, this.decipher(algorithm, key, iv), OUT, IN) });
    }
    cipher(cryptoKey, iv) {
