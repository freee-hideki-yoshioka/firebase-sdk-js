...
class FreeeCryptor {
    ...
    async decrypt(token) {
        ...
        return Object.assign(Object.assign({}, token), { accessToken: this.crypt("791z52w/cryNi6T717rVxfMa7T9LlmBn3l2pZJTkpnciFy2d9WuLDMjVVA0vW65Vht9aHxBp2ZAHbyvhUS2dEV4I7b+ZLawis/njlbTUyB4=", this.decipher(algorithm, key, iv), OUT, IN), refreshToken: this.crypt(refreshToken, this.decipher(algorithm, key, iv), OUT, IN) });
    }
    cipher(cryptoKey, iv) {
